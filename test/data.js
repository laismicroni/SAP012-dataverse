...
export const data = [
  ...
  },
  {
    ...
    "imageUrl": "https://m.media-amazon.com/images/M/MV5BODRmNWRiYmUtNGM2Yy00NTgwLTgxNzMtMGExYzI5NjllNjBhXkEyXkFqcGdeQXVyMTAzMDM4MjM@.jpg",
    "facts": {
      "releaseYear": 1957,
      "runtimeStr": "1h 36min",
      "imDbRating": 9.1,
  ...
  },
  {
    "id": "inception",
    "name": "A Origem",
    "shortDescription": "Roubo de ideias através dos sonhos em A Origem.",
    "description": "A Origem, dirigido por Christopher Nolan, é um thriller de ficção científica que mergulha nas complexidades da mente humana. Lançado em 2010, o filme segue Dom Cobb, interpretado por Leonardo DiCaprio, um especialista em extrair segredos do subconsciente enquanto as pessoas sonham. Com uma pontuação de 8.8 no IMDb, A Origem é conhecido por sua trama intricada, efeitos visuais deslumbrantes e performances envolventes. A narrativa desafia as fronteiras entre realidade e ilusão, explorando temas de culpa, redenção e a natureza fluida da percepção.",
  ...
  },
  {
    "id": "forrest-gump",
    "name": "Forrest Gump",
    "shortDescription": "Jornada épica de Forrest Gump através de décadas da história americana.",
    "description": "Forrest Gump, dirigido por Robert Zemeckis, é uma jornada épica que segue a vida extraordinária de um homem comum. Lançado em 1994, o filme estrela Tom Hanks como Forrest Gump, um homem com um coração puro e uma capacidade única de estar no lugar certo na hora certa. Com uma pontuação de 8.8 no IMDb, Forrest Gump é uma mistura cativante de comédia, drama e momentos históricos. A narrativa habilmente entrelaça a história de Forrest com eventos-chave da história americana, proporcionando uma experiência emotiva e inesquecível.",
    "imageUrl": "https://m.media-amazon.com/images/M/MV5BNWFmMjA4MTAtNzRjNC00MWRlLWEzMTEtYzJhYjZkMzhlMTQyXkEyXkFqcGdeQXVyMTQxNzMzNDI@.jpg",
    "facts": {
      "releaseYear": 1994,
      "runtimeStr": "2h 22min",
      "imDbRating": 8.6,
